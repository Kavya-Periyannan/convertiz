...
<head>
    ...
    <script>
        function convertCelsiusToKelvin() {
            var inputCelsius = parseFloat(document.getElementById("celsiusInput").value);
            var kelvin = inputCelsius + 273.15;
  ...
  <li class="nav-item dropdown">
      ...
      <li class="nav-item ">
        <a class="nav-link" href="login.php">Log In</a>
          ...
          <div class="whole">
    <p class="head">Celsius to Kelvin:</p>
    <br>
    <p class="input"><input type="number" id="celsiusInput" class="form-control" placeholder="Enter celsius"  width="40px"></p>
   <center><button onclick="convertCelsiusToKelvin()" class="btn btn-dark">Convert</button></center> 
  <br>
    <div class="ans"><p id="kelvinOutput"></p></div>
    </div>
    <br><br><br>
