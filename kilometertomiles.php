...
<head>
    ...
    <script>
          function convertKMToMiles() {
            var inputKilometers = parseFloat(document.getElementById("kilometersInput").value);
            var miles = inputKilometers * 0.621371;
            document.getElementById("milesOutput").innerHTML = miles + " miles";
        }
    </script>
...
<img src="head.jpg" width="100%" height="150px">
    ...
    <div class="whole">
    <p class="head">Kilometers to Miles:</p>
    <br>
    <p class="input"><input type="number" id="kilometersInput" class="form-control" placeholder="Enter kilometers"  width="40px"></p><br>
   <center><button onclick="convertKMToMiles()" class="btn btn-dark">Convert</button></center> 
   <br>
    <div class="ans"><p id="milesOutput"></p></div>
    </div> <br><br><br>
