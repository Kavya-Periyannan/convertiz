...
20% {
  transform: translateY(-20px)
       ...
       body{
       /* background-image:linear-gradient(195deg,#4169e1,white);*/
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark sticky-top">
      ...
      <span style="--i:13">M</span></marquee>
        ...
        <center><h3 class="uc">Welcome<b> <?php echo $_SESSION['username'];?>!!!</b></h3>
<h3>Your Email Id: <?php echo $_SESSION['email'];?>!</h3>
 <br>
