...
<head>
    ...
    <script>
        function convertKgToGrams() {
            var inputKg = parseFloat(document.getElementById("kgInput1").value);
            var grams = inputKg * 1000;
            document.getElementById("gramsOutput1").innerHTML = grams + " g";
        }
    </script>
...
<img src="head.jpg" width="100%" height="150px">
  ...
  <div class="collapse navbar-collapse" id="navbarNav">
    ...
    <div class="whole">
    <p class="head">Kilograms to Grams:</p>
    <br>
    <p class="input"><input type="number" id="kgInput1" class="form-control" placeholder="Enter kilograms"  width="40px"></p>
   <center><button onclick="convertKgToGrams()" class="btn btn-dark">Convert</button></center> 
   <br>
    <div class="ans"><p id="gramsOutput1"></p></div>
    </div><br><br><br>
