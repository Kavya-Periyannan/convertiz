...
<head>
    ...
    <script>
        function convertMToCM() {
            var inputMeters = parseFloat(document.getElementById("metersInput").value);
            var centimeters = inputMeters * 100;
            document.getElementById("centimetersOutput").innerHTML = centimeters + " cm";
        }
    </script>
...
<img src="head.jpg" width="100%" height="150px">
    ...
    <div class="whole">
    <p class="head">Meters to CentiMeter</p>
    <br>
    <p class="input"><input type="number" id="metersInput" class="form-control" placeholder="Enter meters"  width="40px"></p><br>
   <center><button onclick="convertMToCM()" class="btn btn-dark">Convert</button></center> 
   <br>
    <div class="ans"><p id="centimetersOutput"></p></div>
    </div>
