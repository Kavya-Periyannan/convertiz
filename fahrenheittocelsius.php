...
<head>
    ...
    <script>
       function convertFahrenheitToCelsius() {
            var inputFahrenheit = parseFloat(document.getElementById("fahrenheitInput").value);
            var celsius = (inputFahrenheit - 32) * (5/9);
            document.getElementById("celsiusOutput2").innerHTML = celsius.toFixed(2) + " °C";
        }
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item ">
        <a class="nav-link" href="login.php">Log In</a>
          ...
          <div class="whole">
    <p class="head">Fahrenheit to Celsius:</p>
    <br>
    <p class="input"><input type="number" id="fahrenheitInput" class="form-control" placeholder="Enter Fahrenheit"  width="40px"></p>
   <center><button onclick="convertFahrenheitToCelsius()" class="btn btn-dark">Convert</button></center> 
  <br>
    <div class="ans"><p id="celsiusOutput2"></p></div>
    </div>
    <br><br><br>
    <footer class="footer p-5" > 
            ...
            <hr> 
            <div class="row"> 
                <div class="col"> <p>© 2024 CONVERTIZ. All rights reserved.</p> <p>© 2024 Your Website. All rights reserved.</p> 
                </div> 
                <div class="col"> 
