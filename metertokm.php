...
<head>
    ...
    <script>
        function convertMToKM() {
            ...
            var kilometers = inputMeters / 1000;
            document.getElementById("kilometersOutput").innerHTML = kilometers + " km";
        }
    </script>
...
<img src="head.jpg" width="100%" height="150px">
    ...
    <div class="whole">
    <p class="head">Meter to KiloMeter</p>
    <br>
    <p class="input"><input type="number" id="metersInput" class="form-control" placeholder="Enter meters"  width="40px"></p><br>
   <center><button onclick="convertMToKM()" class="btn btn-dark">Convert</button></center> 
   <br>
    <div class="ans"><p id="kilometersOutput"></p></div>
    </div> <br><br><br>
