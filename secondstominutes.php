...
<head>
    ...
    <script>
       function convertSecondsToMinutes() {
            var inputSeconds = parseFloat(document.getElementById("secondsInput").value);
            var minutes = inputSeconds / 60;
            document.getElementById("minutesOutput2").innerHTML = minutes + " minutes";
        }
...
<img src="head.jpg" width="100%" height="150px">
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark sticky-top">
      ...
      <div class="whole">
    <p class="head">Seconds to Minutes:</p>
    <br>
    <p class="input"><input type="number" id="secondsInput" class="form-control" placeholder="Enter seconds"  
        width="40px"></p><br>
   <center><button onclick="convertSecondsToMinutes()" class="btn btn-dark">Convert</button></center> 
   <br>
    <div class="ans"><p id="minutesOutput2"></p></div>
    </div> <br><br><br>
