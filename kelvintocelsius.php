...
<head>
    ...
    <script>
       ...
       function convertKelvinToCelsius() {
            var inputKelvin = parseFloat(document.getElementById("kelvinInput").value);
            var celsius = inputKelvin - 273.15;
            document.getElementById("celsiusOutput1").innerHTML = celsius.toFixed(2) + " °C";
        }
    </script>
...
<img src="head.jpg" width="100%" height="150px"><nav class="navbar navbar-expand-lg navbar-dark bg-dark sticky-top">
  ...
  <div class="collapse navbar-collapse" id="navbarNav">
    <ul class="navbar-nav">
      ...
      <li class="nav-item ">
       ...
       <div class="whole">
    <p class="head">Kelvin to Celsius:</p>
    <br>
    <p class="input"><input type="number" id="kelvinInput" class="form-control" placeholder="Enter kelvin"  width="40px"></p>
   <center><button onclick="convertKelvinToCelsius()" class="btn btn-dark">Convert</button></center> 
   <br>
    <div class="ans"><p id="celsiusOutput1"></p></div>
    </div><br><br><br>
