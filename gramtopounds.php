...
<head>
    ...
    <script>
       function convertGramsToPounds() {
            var inputGrams = parseFloat(document.getElementById("gramsInput").value);
            var pounds = inputGrams / 453.592;
            document.getElementById("poundsOutput2").innerHTML = pounds.toFixed(2) + " lbs";
        }
    </script>
...
<img src="head.jpg" width="100%" height="150px">
    ...
    <div class="whole">
    <p class="head">Grams to Pounds:</p>
    <br>
    <p class="input"><input type="number" id="gramsInput" class="form-control" placeholder="Enter grams"  width="40px"></p>
   <center><button onclick="convertGramsToPounds()" class="btn btn-dark">Convert</button></center> 
   <br>
    <div class="ans"><p id="poundsOutput2"></p></div>
    </div>
    <br><br><br>
