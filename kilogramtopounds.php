...
<head>
    ...
    <script>
         function convertKgToPounds() {
            var inputKg = parseFloat(document.getElementById("kgInput2").value);
            var pounds = inputKg * 2.20462;
            document.getElementById("poundsOutput1").innerHTML = pounds.toFixed(2) + " lbs";
        }
    </script>
...
<img src="head.jpg" width="100%" height="150px">
    ...
    <div class="whole">
    <p class="head">Kilograms to Pounds:</p>
    <br>
    <p class="input"><input type="number" id="kgInput2" class="form-control" placeholder="Enter kilograms"  width="40px"></p>
   <center><button onclick="convertKgToPounds()" class="btn btn-dark">Convert</button></center> 
   <br>
    <div class="ans"><p id="poundsOutput1"></p></div>
    </div>
    <br><br><br>
