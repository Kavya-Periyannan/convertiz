...
<head>
    ...
    <script>
         function convertHoursToSeconds() {
            var inputHours = parseFloat(document.getElementById("hoursInput1").value);
            var seconds = inputHours * 3600;
            document.getElementById("secondsOutput1").innerHTML = seconds + " seconds";
        }
    </script>
...
<body>
   ...
   <div class="whole">
    <p class="head">Hours to seconds:</p>
    <br>
    <p class="input"><input type="number" id="hoursInput1" class="form-control" placeholder="Enter hours"  width="40px"></p><br>
   <center><button onclick="convertHoursToSeconds()" class="btn btn-dark">Convert</button></center> 
   <br>
    <div class="ans"><p id="secondsOutput1"></p></div>
    </div><br><br><br>
